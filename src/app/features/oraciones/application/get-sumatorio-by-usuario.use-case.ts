...
@Injectable()
export class GetSumatorioByUsuarioUseCase {
  private readonly oracionesPort = inject(OracionesPort);

  execute(usuarioId: number): Observable<SumatorioOraciones> {
    return this.oracionesPort.getSumatorioByUsuario(usuarioId);
  }
}
